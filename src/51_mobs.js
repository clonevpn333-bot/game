...
defMob('spider', {
  model: {
    parts: [
      ...
      P('l1', [4, 9, -4], [0, -1, -1, 12, 2, 2], '#1f130d'),
      P('l2', [-4, 9, -4], [-12, -1, -1, 12, 2, 2], '#1f130d'),
      P('l3', [4, 9, -1], [0, -1, -1, 12, 2, 2], '#1f130d'),
      P('l4', [-4, 9, -1], [-12, -1, -1, 12, 2, 2], '#1f130d'),
      P('l5', [4, 9, 2], [0, -1, -1, 12, 2, 2], '#1f130d'),
      P('l6', [-4, 9, 2], [-12, -1, -1, 12, 2, 2], '#1f130d'),
      P('l7', [4, 9, 5], [0, -1, -1, 12, 2, 2], '#1f130d'),
      P('l8', [-4, 9, 5], [-12, -1, -1, 12, 2, 2], '#1f130d')
    ], eye: 0.65
  },
