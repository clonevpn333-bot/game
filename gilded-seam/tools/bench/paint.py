...
MATS: dict[str, tuple] = {
    ...
    # A fox's muzzle and cheeks are white, and it is most of the face you read.
    "fox_snout":    ((236, 231, 224), (208, 202, 194), (150, 144, 136), (246, 244, 240), (253, 252, 250)),
    "rabbit_nose":  ((196, 140, 140), (168, 112, 112), (112, 68, 68), (216, 168, 168), (234, 200, 200)),
    # Underside of a pelt: pale, greasy, and wrong to look at.
    "hide_torn":    ((166, 132, 118), (138, 106, 94), (90, 66, 58), (192, 162, 148), (214, 190, 178)),
    # A human iris, so people do not stare out with the same lamps the
    # monsters do.
    "eye_human":    ((238, 236, 230), (74, 96, 108), (18, 18, 22), (250, 249, 246), (255, 255, 255)),
    # The taken. Each keeps the colour you know it by, gone wrong.
    "sculkflesh":   ((38, 62, 66), (28, 48, 52), (14, 26, 30), (56, 88, 92), (86, 130, 134)),
    "bonewood":     ((214, 208, 190), (184, 178, 160), (120, 114, 100), (232, 228, 214), (246, 244, 236)),
    "dragonhide":   ((36, 30, 42), (26, 21, 31), (12, 10, 16), (58, 48, 68), (92, 78, 108)),
    "voidflesh":    ((22, 20, 26), (15, 14, 19), (7, 6, 9), (40, 36, 48), (66, 60, 80)),
    "comb_red":     ((186, 48, 44), (154, 34, 32), (98, 18, 18), (208, 78, 70), (230, 118, 108)),
