...
(async () => {
    ...
    await page.evaluate(() => {
        ...
        const def = SHOW.find(d => d.id === 'stompin_ground');
    ...
    const views = {
        over:  { pos: [640, 1180, 1060], look: [640, 0, 400] },
        se34:  { pos: [1160, 560, 980],  look: [620, 60, 360] },
        low:   { pos: [640, 240, 1120],  look: [640, 80, 360] },
        high:  { pos: [980, 980, 980],   look: [620, 30, 380] },
    };
    for (const [tag, v] of Object.entries(views)) {
        ...
        await wait(450);
        await page.screenshot({ path: path.join(SHOTS, `stompin-${tag}.png`) });
    ...
    await page.screenshot({ path: path.join(SHOTS, 'stompin-chase.png') });
