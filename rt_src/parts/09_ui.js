...
RT.ui = (() => {
  ...
  function buildScreens() {
    ...
    const mm = screenShell('main-menu',
      ...
      '<div class="menu-foot">Click to engage · WASD move · Mouse look</div>');
    ...
    screenShell('pause-screen',
      ...
      '<div class="paused-note">WASD move · SHIFT sprint · C crouch · SPACE jump · R reload<br>' +
      '1-4 weapons · G grenade (hold to cook) · F interact · L arrow-key look</div>');
