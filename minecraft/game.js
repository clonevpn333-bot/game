...
class Game {
  ...
  makeHand() {
    ...
    const skin = new THREE.Mesh(new THREE.BoxGeometry(0.28, 0.28, 0.8), new THREE.MeshBasicMaterial({ color: 0xe7b58a }));
    skin.geometry.translate(0, 0, -0.3); arm.add(skin); this.arm = skin;
    const sleeve = new THREE.Mesh(new THREE.BoxGeometry(0.32, 0.32, 0.34), new THREE.MeshBasicMaterial({ color: 0x3f7cb4 }));
    sleeve.position.set(0, 0, 0.18); arm.add(sleeve); this.sleeve = sleeve;
