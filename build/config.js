...
const SHOW = [
    ...
    { id: 'block_party',   name: 'Block Party',   category: 'Survival', build: 'blockParty',   duration: 30,
      tagline: 'Walls slide across the floor — slip through the gaps or get shoved off!' },
