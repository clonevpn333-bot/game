...
class Game {
  ...
  loop() {
    ...
    this.updateDayNight();
    if (this.playing) { this.updateTraffic(dt); this.updateStorm(dt); }
  ...
  control(dt, inp) {
    ...
    for (const o of this.game.cars) {
      ...
      if (dd < 3.6 && dd > 0.01) {
        ...
        if (hit > 6 && (this._ramCd || 0) <= 0) { this._ramCd = 0.4; this.game.hitFx(o.pos.clone().setY(1), 0xffe27a, 6); if (o.fleeing) { o._rams = (o._rams || 0) + 1; if (o._rams >= 2 && !o._boom) { o._boom = true; o.fleeing = false; o.ai = false; o.speed = 0; o.cruise = 0; this.game.explode(o.pos.clone().setY(1.0), 1.15, o.color); o.removeMe = true; } } }
